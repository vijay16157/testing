            ...
            this.on('route:BeforeComplete', function (req, res) {
                ...
                try {
                    Transaction.wrap(function () {
                	    ...
                	    CustomObject.custom.phone = newsletterForm.phone.value;
                	    CustomObject.custom.birthday = newsletterForm.birthday.value;
...
//                        });
                	...
                	if (err.javaName === "MetaDataException") {
                		...
                		Logger.getLogger("register user").error(Resource.msg('error.customobjectmissing', 'newsletter', null));
